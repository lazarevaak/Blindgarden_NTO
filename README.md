...
3) Взятие проб воды из озера
    1) Пролететь до озера
    2) Опуститься над озером (0.4 - 0.7 метров) на 5 секунд
    3) Вывод в терминал сообщения о успешном взятии пробы воды
